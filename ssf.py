...
def run():
	...
	plt.legend()
	plt.xlabel(r'$r$ (normalized subaperture separation)')
	plt.ylabel(r'$D(r)$')
	plt.savefig('full_ssf.png', bbox_inches='tight')
	plt.show()
	...
	plt.legend()
	plt.xlabel(r'$r$ (normalized subaperture separation)')
	plt.ylabel(r'$D_{x,y}(r)$')
	plt.savefig('xy_ssf.png', bbox_inches='tight')
	plt.show()
